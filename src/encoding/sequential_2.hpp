#ifndef SEQUENTIAL_2_HPP
#define SEQUENTIAL_2_HPP
...
class Sequential2Encoder : public Encoder {
...
public:
  ...
  explicit Sequential2Encoder(const model::Problem &problem)
      : Encoder{problem} {}
...
#endif /* end of include guard: SEQUENTIAL_2_HPP */
